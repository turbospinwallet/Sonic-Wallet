const stakingAbi = [
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'uint256', name: 'tokenId', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'stakedAtTimestamp', type: 'uint256' },
      {
        indexed: false,
        internalType: 'uint256',
        name: 'removedFromStakeAtTimestamp',
        type: 'uint256',
      },
    ],
    name: 'Unstake',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256[]', name: 'airdropTokenIds', type: 'uint256[]' },
    ],
    name: 'airdrop',
    outputs: [],
  ...
  {
    inputs: [{ internalType: 'bool', name: '_transferDisabled', type: 'bool' }],
    name: 'setTransferDisabled',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
