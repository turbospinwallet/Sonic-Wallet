      ...
      <div className="container mx-auto px-6">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-neutral/70 max-w-sm">
          ...
          {footerLinks.map((section) => (
            <div
              ...
              className="space-y-4"
            >
              <h4 className="text-neutral font-semibold">{section.title}</h4>
              <ul className="space-y-2">
                {section.items.map((item) => (
                  <li key={item.label}>
                    <Link
                      href={item.href}
                      className="text-neutral/70 hover:text-primary transition-colors duration-300"
                    >
                      {item.label}
                    </Link>
                  </li>
        ...
        {/* Copyright */}
        <div className="py-6 border-t border-neutral/10">
