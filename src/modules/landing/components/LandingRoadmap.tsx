...
export default function LandingRoadmap() {
  return (
    <section
      className="py-16 md:py-24 bg-secondary relative"
      id="roadmap"
    >
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-1 bg-primary/20 md:transform md:-translate-x-1/2" />
          ...
          <div className="space-y-8 md:space-y-16">
            {roadmapData.map((stage, index) => (
              ...
              >
                {/* Content */}
                <div className="ml-12 md:ml-0 md:w-1/2 p-4 md:p-6 bg-white/5 rounded-xl border border-white/10 backdrop-blur-sm">
                  ...
                  <ul className="space-y-2">
                    {stage.items.map((item, itemIndex) => (
                      <li
                        key={itemIndex}
                        className="flex items-center gap-2 text-sm md:text-base text-neutral"
                      >
                ...
                {/* Timeline dot - Absolute positioned for mobile */}
